...
def update_titles(app):
    ...
    def update_titles(selected_country):
        if selected_country:
            ...
            overview_section_evolution_title = f"Evolution in number of attacks overtime in {selected_country}"
            ...
            types_section_evolution_title = f"Evolution in number of attacks overtime in {selected_country}"
            types_section_techniques_bar_title = f"MITRE Initial Access techniques used in attacks against {selected_country}"
            initiators_section_main_title = f"Top initiators of cyber attacks in {selected_country}"
            ...
            initiators_section_conflicts_main_title = f"Number of cyber attacks linked to offline conflicts in {selected_country} (coded since 2023)"
        else:
            overview_section_main_title = "Overview of cyber incidents"
            overview_section_aggregate_title = "Top targeted sectors"
            overview_section_evolution_title = "Evolution in number of attacks overtime"
            ...
            initiators_section_main_title = "Top initiators of cyber attacks"
            ...
            initiators_section_conflicts_main_title = "Number of cyber attacks linked to offline conflicts (coded since 2023)"
